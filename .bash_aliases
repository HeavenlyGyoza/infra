# DOCKER COMPOSE
alias dcup='sudo docker compose -f $HOME/docker/docker-compose.yml up -d'
alias dcdown='sudo docker compose -f $HOME/docker/docker-compose.yml down --remove-orphans'
alias dcrecreate='sudo docker compose -f $HOME/docker/docker-compose.yml up -d --force-recreate --remove-orphans'
alias dcrestart='sudo docker compose -f $HOME/docker/docker-compose.yml restart'
alias dcstop='sudo docker compose -f $HOME/docker/docker-compose.yml stop'
alias dclogs='sudo docker logs -tf --tail="50"'
alias dcpull='sudo docker compose -f $HOME/docker/docker-compose.yml pull'
